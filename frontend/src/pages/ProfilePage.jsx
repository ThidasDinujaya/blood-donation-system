  ...
  return (
    <div className="page">
      ...
      <div className="page-header" style={{ borderBottom: 'none', paddingBottom: 0, marginBottom: 20 }}>
        <h1>Edit Profile</h1>
        <p>Update your personal information and donation preferences</p>
      </div>
        ...
        <form onSubmit={onSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div className="form-group">
            <label htmlFor="prof-password">
              New password{' '}
              <span style={{ color: 'var(--text-3)', textTransform: 'none', fontWeight: 400 }}>(leave blank to keep current)</span>
            </label>
            <input id="prof-password" className="input" type="password" name="password"
